...
public abstract class SparkBase {
    ...
    protected static SparkSessionIdManager sessionIdManager;
    protected static SparkSessionManager sessionManager;
     ...
     * @deprecated replaced by {@link #sessionIdManager(SparkSessionIdManager)}
     */
    ...
    public static synchronized void sessionIdManager(SparkSessionIdManager sessionIdManager) {
        if (initialized) {
            throwBeforeRouteMappingException();
        }
        Spark.sessionIdManager = sessionIdManager;
     ...
     * @deprecated replaced by {@link #sessionManager(SparkSessionManager)}
     */
    ...
    public static synchronized void sessionManager(SparkSessionManager sessionManager) {
        if (initialized) {
            throwBeforeRouteMappingException();
        }
        Spark.sessionManager = sessionManager;
